 ...
 * @param {number} value 반올림시킬 값을 인자로 받습니다.
...
/**
 * 값을 받아 계산기 디스플레이에 표시하기 위한 형식으로 변환합니다.
 * @param {number} value 계산기 디스플레이에 표시할 값을 인자로 받습니다.
 * @returns {number | string} 값의 유효숫자가 10개를 초과하면, 지수 표기법으로 변경하며 가수의 소수점 아래 5자리에서 반올림하여 반환합니다. 초과하지 않으면 값 그대로 반환합니다.
 */
